import { TrainingAI } from "../training/TrainingAI";

export function Player(i, ai, b){
	// Properties
	var self = this;
	...
	var team: any[] = []; // Array of Pokemon in the battle
	var roster: any[] = []; // Array of full 6 Pokemon on the team
